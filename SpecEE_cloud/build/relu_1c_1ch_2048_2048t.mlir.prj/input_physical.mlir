module {
  aie.device(npu2) {
    ...
    %out0_0_buff_0 = aie.buffer(%tile_0_2) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "out0_0_buff_0"} : memref<2048xbf16> 
    %out0_0_buff_1 = aie.buffer(%tile_0_2) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "out0_0_buff_1"} : memref<2048xbf16> 
    ...
    %in0_0_cons_buff_0 = aie.buffer(%tile_0_2) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "in0_0_cons_buff_0"} : memref<2048xbf16> 
    %in0_0_cons_buff_1 = aie.buffer(%tile_0_2) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "in0_0_cons_buff_1"} : memref<2048xbf16> 
    ...
    ^bb3:  // pred: ^bb2
      cf.br ^bb6(%out0_0_buff_0 : memref<2048xbf16>)
    ^bb4:  // pred: ^bb2
      cf.br ^bb6(%out0_0_buff_1 : memref<2048xbf16>)
    ^bb5:  // pred: ^bb2
      cf.br ^bb6(%out0_0_buff_0 : memref<2048xbf16>)
    ...
    ^bb7:  // pred: ^bb6
      cf.br ^bb10(%in0_0_cons_buff_0 : memref<2048xbf16>)
    ^bb8:  // pred: ^bb6
      cf.br ^bb10(%in0_0_cons_buff_1 : memref<2048xbf16>)
    ^bb9:  // pred: ^bb6
      cf.br ^bb10(%in0_0_cons_buff_0 : memref<2048xbf16>)
    ^bb10(%9: memref<2048xbf16>):  // 3 preds: ^bb7, ^bb8, ^bb9
      func.call @relu_bf16(%9, %5, %c2048_i32) : (memref<2048xbf16>, memref<2048xbf16>, i32) -> ()
    ...
    ^bb1:  // 2 preds: ^bb0, ^bb2
      ...
      aie.dma_bd(%in0_0_cons_buff_0 : memref<2048xbf16>, 0, 2048) {bd_id = 0 : i32, next_bd_id = 1 : i32}
      aie.use_lock(%in0_0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb2
    ^bb2:  // pred: ^bb1
      aie.use_lock(%in0_0_cons_prod_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%in0_0_cons_buff_1 : memref<2048xbf16>, 0, 2048) {bd_id = 1 : i32, next_bd_id = 0 : i32}
      aie.use_lock(%in0_0_cons_cons_lock_0, Release, 1)
      aie.next_bd ^bb1
    ^bb3:  // pred: ^bb0
    ...
    ^bb4:  // 2 preds: ^bb3, ^bb5
      ...
      aie.dma_bd(%out0_0_buff_0 : memref<2048xbf16>, 0, 2048) {bd_id = 2 : i32, next_bd_id = 3 : i32}
      aie.use_lock(%out0_0_prod_lock_0, Release, 1)
      aie.next_bd ^bb5
    ^bb5:  // pred: ^bb4
      aie.use_lock(%out0_0_cons_lock_0, AcquireGreaterEqual, 1)
      aie.dma_bd(%out0_0_buff_1 : memref<2048xbf16>, 0, 2048) {bd_id = 3 : i32, next_bd_id = 2 : i32}
      aie.use_lock(%out0_0_prod_lock_0, Release, 1)
      aie.next_bd ^bb4
    ^bb6:  // pred: ^bb3
      aie.end
