module {
  aie.device(npu2) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      aie.end
    } {elf_file = "/home/steven/thesis/parrallel/SpecEE/SpecEE_cloud/build/relu_2c_1ch_2048_1024t.mlir.prj/main_core_0_2.elf", link_with = "relu.o"}
    %_anonymous1 = aie.buffer(%tile_0_3) {address = 3072 : i32, mem_bank = 0 : i32, sym_name = "_anonymous1"} : memref<2xi32> 
    %core_0_3 = aie.core(%tile_0_3) {
      aie.end
    } {elf_file = "/home/steven/thesis/parrallel/SpecEE/SpecEE_cloud/build/relu_2c_1ch_2048_1024t.mlir.prj/main_core_0_3.elf", link_with = "relu.o"}
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[512, 0, 0, 0, -1073741824, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[512, 2048, 0, 0, -1073741824, 33554432, 0, 33554432]>
    aie.runtime_sequence(%arg0: memref<2048xbf16>, %arg1: memref<2048xbf16>) {
      ...
      aiex.npu.address_patch {addr = 118884 : ui32, arg_idx = 1 : i32, arg_plus = 2048 : i32}
