module {
  aie.device(npu2) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      aie.end
    } {elf_file = "/home/steven/thesis/parrallel/SpecEE/SpecEE_cloud/build/weighted_rms_1c_2ch_4096_2048t.mlir.prj/main_core_0_2.elf", link_with = "rms_norm_archive.a"}
    %_anonymous1 = aie.buffer(%tile_0_3) {address = 5120 : i32, mem_bank = 0 : i32, sym_name = "_anonymous1"} : memref<3xi32> 
    %core_0_3 = aie.core(%tile_0_3) {
      aie.end
    } {elf_file = "/home/steven/thesis/parrallel/SpecEE/SpecEE_cloud/build/weighted_rms_1c_2ch_4096_2048t.mlir.prj/main_core_0_3.elf", link_with = "rms_norm_archive.a"}
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[2048, 0, 0, 0, -1073741824, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[1024, 0, 0, 0, -1073741824, 33554432, 0, 33554432]>
