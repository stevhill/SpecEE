; ModuleID = '/home/steven/thesis/parrallel/SpecEE/SpecEE_cloud/build/relu_8c_1ch_1024_128t.mlir.prj/main_input.llpeanohack.ll'
source_filename = "LLVMDialectModule"
target datalayout = "e-m:e-p:20:32-i1:8:32-i8:8:32-i16:16:32-i32:32:32-f32:32:32-i64:32-f64:32-a:0:32-n32"
target triple = "aie2p"

@_anonymous7 = external local_unnamed_addr global [2 x i32]
@_anonymous6 = external local_unnamed_addr global [2 x i32]
@_anonymous5 = external local_unnamed_addr global [2 x i32]
@_anonymous4 = external local_unnamed_addr global [2 x i32]
...
1:                                                ; preds = %0, %1
  ...
  %3 = load i32, ptr @_anonymous7, align 4
  %cond = icmp eq i32 %3, 1
  tail call void @llvm.aie2p.acquire(i32 49, i32 -1)
  %4 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous7, i20 4), align 4
  %cond1 = icmp eq i32 %4, 1
  %5 = select i1 %cond1, ptr @in7_0_cons_buff_1, ptr @in7_0_cons_buff_0
  %6 = select i1 %cond, ptr @out7_0_buff_1, ptr @out7_0_buff_0
  tail call void @relu_bf16(ptr nonnull %5, ptr nonnull %6, i32 128)
  ...
  store i32 %11, ptr getelementptr inbounds nuw (i8, ptr @_anonymous7, i20 4), align 4
  ...
  store i32 %16, ptr @_anonymous7, align 4
...
1:                                                ; preds = %0, %1
  %2 = phi i64 [ 0, %0 ], [ %17, %1 ]
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  %3 = load i32, ptr @_anonymous6, align 4
  %cond = icmp eq i32 %3, 1
  tail call void @llvm.aie2p.acquire(i32 49, i32 -1)
  %4 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous6, i20 4), align 4
  %cond1 = icmp eq i32 %4, 1
  %5 = select i1 %cond1, ptr @in6_0_cons_buff_1, ptr @in6_0_cons_buff_0
  %6 = select i1 %cond, ptr @out6_0_buff_1, ptr @out6_0_buff_0
  tail call void @relu_bf16(ptr nonnull %5, ptr nonnull %6, i32 128)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  ...
  %10 = add i32 %7, -1
  %11 = select i1 %9, i32 %10, i32 %8
  store i32 %11, ptr getelementptr inbounds nuw (i8, ptr @_anonymous6, i20 4), align 4
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  ...
  %15 = add i32 %12, -1
  %16 = select i1 %14, i32 %15, i32 %13
  store i32 %16, ptr @_anonymous6, align 4
  %17 = add nuw nsw i64 %2, 1
  %.not = icmp eq i64 %17, 9223372036854775807
  br i1 %.not, label %18, label %1
...
1:                                                ; preds = %0, %1
  %2 = phi i64 [ 0, %0 ], [ %17, %1 ]
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  %3 = load i32, ptr @_anonymous5, align 4
  %cond = icmp eq i32 %3, 1
  tail call void @llvm.aie2p.acquire(i32 49, i32 -1)
  %4 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous5, i20 4), align 4
  %cond1 = icmp eq i32 %4, 1
  %5 = select i1 %cond1, ptr @in5_0_cons_buff_1, ptr @in5_0_cons_buff_0
  %6 = select i1 %cond, ptr @out5_0_buff_1, ptr @out5_0_buff_0
  tail call void @relu_bf16(ptr nonnull %5, ptr nonnull %6, i32 128)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  ...
  %10 = add i32 %7, -1
  %11 = select i1 %9, i32 %10, i32 %8
  store i32 %11, ptr getelementptr inbounds nuw (i8, ptr @_anonymous5, i20 4), align 4
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  ...
  %15 = add i32 %12, -1
  %16 = select i1 %14, i32 %15, i32 %13
  store i32 %16, ptr @_anonymous5, align 4
  %17 = add nuw nsw i64 %2, 1
  %.not = icmp eq i64 %17, 9223372036854775807
  br i1 %.not, label %18, label %1
...
1:                                                ; preds = %0, %1
  %2 = phi i64 [ 0, %0 ], [ %17, %1 ]
  tail call void @llvm.aie2p.acquire(i32 50, i32 -1)
  %3 = load i32, ptr @_anonymous4, align 4
  %cond = icmp eq i32 %3, 1
  tail call void @llvm.aie2p.acquire(i32 49, i32 -1)
  %4 = load i32, ptr getelementptr inbounds nuw (i8, ptr @_anonymous4, i20 4), align 4
  %cond1 = icmp eq i32 %4, 1
  %5 = select i1 %cond1, ptr @in4_0_cons_buff_1, ptr @in4_0_cons_buff_0
  %6 = select i1 %cond, ptr @out4_0_buff_1, ptr @out4_0_buff_0
  tail call void @relu_bf16(ptr nonnull %5, ptr nonnull %6, i32 128)
  tail call void @llvm.aie2p.release(i32 48, i32 1)
  ...
  %10 = add i32 %7, -1
  %11 = select i1 %9, i32 %10, i32 %8
  store i32 %11, ptr getelementptr inbounds nuw (i8, ptr @_anonymous4, i20 4), align 4
  tail call void @llvm.aie2p.release(i32 51, i32 1)
  ...
  %15 = add i32 %12, -1
  %16 = select i1 %14, i32 %15, i32 %13
  store i32 %16, ptr @_anonymous4, align 4
  %17 = add nuw nsw i64 %2, 1
  %.not = icmp eq i64 %17, 9223372036854775807
  br i1 %.not, label %18, label %1
