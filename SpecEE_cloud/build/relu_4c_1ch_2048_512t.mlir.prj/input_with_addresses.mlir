module {
  aie.device(npu2) {
    ...
    %out3_0_buff_0 = aie.buffer(%tile_0_5) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "out3_0_buff_0"} : memref<512xbf16> 
    %out3_0_buff_1 = aie.buffer(%tile_0_5) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "out3_0_buff_1"} : memref<512xbf16> 
    ...
    %out2_0_buff_0 = aie.buffer(%tile_0_4) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "out2_0_buff_0"} : memref<512xbf16> 
    %out2_0_buff_1 = aie.buffer(%tile_0_4) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "out2_0_buff_1"} : memref<512xbf16> 
    ...
    %out1_0_buff_0 = aie.buffer(%tile_0_3) {address = 1024 : i32, mem_bank = 0 : i32, sym_name = "out1_0_buff_0"} : memref<512xbf16> 
    %out1_0_buff_1 = aie.buffer(%tile_0_3) {address = 16384 : i32, mem_bank = 1 : i32, sym_name = "out1_0_buff_1"} : memref<512xbf16> 
    ...
    %in3_0_cons_buff_0 = aie.buffer(%tile_0_5) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "in3_0_cons_buff_0"} : memref<512xbf16> 
    %in3_0_cons_buff_1 = aie.buffer(%tile_0_5) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "in3_0_cons_buff_1"} : memref<512xbf16> 
    ...
    %in2_0_cons_buff_0 = aie.buffer(%tile_0_4) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "in2_0_cons_buff_0"} : memref<512xbf16> 
    %in2_0_cons_buff_1 = aie.buffer(%tile_0_4) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "in2_0_cons_buff_1"} : memref<512xbf16> 
    ...
    %in1_0_cons_buff_0 = aie.buffer(%tile_0_3) {address = 32768 : i32, mem_bank = 2 : i32, sym_name = "in1_0_cons_buff_0"} : memref<512xbf16> 
    %in1_0_cons_buff_1 = aie.buffer(%tile_0_3) {address = 49152 : i32, mem_bank = 3 : i32, sym_name = "in1_0_cons_buff_1"} : memref<512xbf16> 
    ...
    func.func private @relu_bf16(memref<512xbf16>, memref<512xbf16>, i32)
    %_anonymous0 = aie.buffer(%tile_0_2) {address = 2048 : i32, mem_bank = 0 : i32, sym_name = "_anonymous0"} : memref<2xi32> 
    ...
    ^bb3:  // pred: ^bb2
      cf.br ^bb6(%out0_0_buff_0 : memref<512xbf16>)
    ^bb4:  // pred: ^bb2
      cf.br ^bb6(%out0_0_buff_1 : memref<512xbf16>)
    ^bb5:  // pred: ^bb2
      cf.br ^bb6(%out0_0_buff_0 : memref<512xbf16>)
    ^bb6(%5: memref<512xbf16>):  // 3 preds: ^bb3, ^bb4, ^bb5
    ...
    ^bb7:  // pred: ^bb6
      cf.br ^bb10(%in0_0_cons_buff_0 : memref<512xbf16>)
    ^bb8:  // pred: ^bb6
      cf.br ^bb10(%in0_0_cons_buff_1 : memref<512xbf16>)
    ^bb9:  // pred: ^bb6
      cf.br ^bb10(%in0_0_cons_buff_0 : memref<512xbf16>)
    ^bb10(%9: memref<512xbf16>):  // 3 preds: ^bb7, ^bb8, ^bb9
      func.call @relu_bf16(%9, %5, %c512_i32) : (memref<512xbf16>, memref<512xbf16>, i32) -> ()
    ...
    %_anonymous1 = aie.buffer(%tile_0_3) {address = 2048 : i32, mem_bank = 0 : i32, sym_name = "_anonymous1"} : memref<2xi32> 
    ...
    ^bb3:  // pred: ^bb2
      cf.br ^bb6(%out1_0_buff_0 : memref<512xbf16>)
    ^bb4:  // pred: ^bb2
      cf.br ^bb6(%out1_0_buff_1 : memref<512xbf16>)
    ^bb5:  // pred: ^bb2
      cf.br ^bb6(%out1_0_buff_0 : memref<512xbf16>)
    ^bb6(%5: memref<512xbf16>):  // 3 preds: ^bb3, ^bb4, ^bb5
    ...
    ^bb7:  // pred: ^bb6
      cf.br ^bb10(%in1_0_cons_buff_0 : memref<512xbf16>)
    ^bb8:  // pred: ^bb6
      cf.br ^bb10(%in1_0_cons_buff_1 : memref<512xbf16>)
    ^bb9:  // pred: ^bb6
      cf.br ^bb10(%in1_0_cons_buff_0 : memref<512xbf16>)
    ^bb10(%9: memref<512xbf16>):  // 3 preds: ^bb7, ^bb8, ^bb9
      func.call @relu_bf16(%9, %5, %c512_i32) : (memref<512xbf16>, memref<512xbf16>, i32) -> ()
    ...
    %_anonymous2 = aie.buffer(%tile_0_4) {address = 2048 : i32, mem_bank = 0 : i32, sym_name = "_anonymous2"} : memref<2xi32> 
    ...
    ^bb3:  // pred: ^bb2
      cf.br ^bb6(%out2_0_buff_0 : memref<512xbf16>)
    ^bb4:  // pred: ^bb2
      cf.br ^bb6(%out2_0_buff_1 : memref<512xbf16>)
    ^bb5:  // pred: ^bb2
      cf.br ^bb6(%out2_0_buff_0 : memref<512xbf16>)
    ^bb6(%5: memref<512xbf16>):  // 3 preds: ^bb3, ^bb4, ^bb5
    ...
    ^bb7:  // pred: ^bb6
      cf.br ^bb10(%in2_0_cons_buff_0 : memref<512xbf16>)
    ^bb8:  // pred: ^bb6
      cf.br ^bb10(%in2_0_cons_buff_1 : memref<512xbf16>)
    ^bb9:  // pred: ^bb6
      cf.br ^bb10(%in2_0_cons_buff_0 : memref<512xbf16>)
    ^bb10(%9: memref<512xbf16>):  // 3 preds: ^bb7, ^bb8, ^bb9
      func.call @relu_bf16(%9, %5, %c512_i32) : (memref<512xbf16>, memref<512xbf16>, i32) -> ()
    ...
    %_anonymous3 = aie.buffer(%tile_0_5) {address = 2048 : i32, mem_bank = 0 : i32, sym_name = "_anonymous3"} : memref<2xi32> 
    ...
    ^bb3:  // pred: ^bb2
      cf.br ^bb6(%out3_0_buff_0 : memref<512xbf16>)
    ^bb4:  // pred: ^bb2
      cf.br ^bb6(%out3_0_buff_1 : memref<512xbf16>)
    ^bb5:  // pred: ^bb2
      cf.br ^bb6(%out3_0_buff_0 : memref<512xbf16>)
    ^bb6(%5: memref<512xbf16>):  // 3 preds: ^bb3, ^bb4, ^bb5
    ...
    ^bb7:  // pred: ^bb6
      cf.br ^bb10(%in3_0_cons_buff_0 : memref<512xbf16>)
    ^bb8:  // pred: ^bb6
      cf.br ^bb10(%in3_0_cons_buff_1 : memref<512xbf16>)
    ^bb9:  // pred: ^bb6
      cf.br ^bb10(%in3_0_cons_buff_0 : memref<512xbf16>)
    ^bb10(%9: memref<512xbf16>):  // 3 preds: ^bb7, ^bb8, ^bb9
      func.call @relu_bf16(%9, %5, %c512_i32) : (memref<512xbf16>, memref<512xbf16>, i32) -> ()
    ...
    aie.runtime_sequence(%arg0: memref<2048xbf16>, %arg1: memref<2048xbf16>) {
      %0 = aiex.dma_configure_task_for @in0_0_shim_alloc {
        aie.dma_bd(%arg0 : memref<2048xbf16>, 0, 512, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 512, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%0)
      %1 = aiex.dma_configure_task_for @in1_0_shim_alloc {
        aie.dma_bd(%arg0 : memref<2048xbf16>, 512, 512, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 512, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%1)
      %2 = aiex.dma_configure_task_for @in2_0_shim_alloc {
        aie.dma_bd(%arg0 : memref<2048xbf16>, 1024, 512, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 512, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%2)
      %3 = aiex.dma_configure_task_for @in3_0_shim_alloc {
        aie.dma_bd(%arg0 : memref<2048xbf16>, 1536, 512, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 512, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      }
      aiex.dma_start_task(%3)
      %4 = aiex.dma_configure_task_for @out0_0_shim_alloc {
        aie.dma_bd(%arg1 : memref<2048xbf16>, 0, 512, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 512, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%4)
      %5 = aiex.dma_configure_task_for @out1_0_shim_alloc {
        aie.dma_bd(%arg1 : memref<2048xbf16>, 512, 512, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 512, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%5)
      %6 = aiex.dma_configure_task_for @out2_0_shim_alloc {
        aie.dma_bd(%arg1 : memref<2048xbf16>, 1024, 512, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 512, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
      aiex.dma_start_task(%6)
      %7 = aiex.dma_configure_task_for @out3_0_shim_alloc {
        aie.dma_bd(%arg1 : memref<2048xbf16>, 1536, 512, [<size = 1, stride = 0>, <size = 1, stride = 0>, <size = 1, stride = 0>, <size = 512, stride = 1>]) {burst_length = 0 : i32}
        aie.end
      } {issue_token = true}
