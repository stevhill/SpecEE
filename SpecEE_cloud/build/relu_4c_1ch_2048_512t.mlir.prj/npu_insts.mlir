module {
  aie.device(npu2) {
    ...
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[256, 0, 0, 0, -1073741824, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[256, 1024, 0, 0, -1073741824, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_2 : memref<8xi32> = dense<[256, 2048, 0, 0, -1073741824, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_3 : memref<8xi32> = dense<[256, 3072, 0, 0, -1073741824, 33554432, 0, 33554432]>
    aie.runtime_sequence(%arg0: memref<2048xbf16>, %arg1: memref<2048xbf16>) {
      ...
      aiex.npu.address_patch {addr = 118820 : ui32, arg_idx = 0 : i32, arg_plus = 1024 : i32}
      ...
      aiex.npu.address_patch {addr = 33673220 : ui32, arg_idx = 0 : i32, arg_plus = 2048 : i32}
      ...
      aiex.npu.address_patch {addr = 33673252 : ui32, arg_idx = 0 : i32, arg_plus = 3072 : i32}
      ...
      aiex.npu.address_patch {addr = 118884 : ui32, arg_idx = 1 : i32, arg_plus = 1024 : i32}
      ...
      %6 = memref.get_global @blockwrite_data_2 : memref<8xi32>
      aiex.npu.blockwrite(%6) {address = 33673280 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 33673284 : ui32, arg_idx = 1 : i32, arg_plus = 2048 : i32}
      ...
      aiex.npu.blockwrite(%7) {address = 33673312 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 33673316 : ui32, arg_idx = 1 : i32, arg_plus = 3072 : i32}
