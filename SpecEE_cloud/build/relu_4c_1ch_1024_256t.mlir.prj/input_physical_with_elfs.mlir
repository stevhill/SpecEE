module {
  aie.device(npu2) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      aie.end
    } {elf_file = "/home/steven/thesis/parrallel/SpecEE/SpecEE_cloud/build/relu_4c_1ch_1024_256t.mlir.prj/main_core_0_2.elf", link_with = "relu.o"}
    %_anonymous1 = aie.buffer(%tile_0_3) {address = 1536 : i32, mem_bank = 0 : i32, sym_name = "_anonymous1"} : memref<2xi32> 
    %core_0_3 = aie.core(%tile_0_3) {
      aie.end
    } {elf_file = "/home/steven/thesis/parrallel/SpecEE/SpecEE_cloud/build/relu_4c_1ch_1024_256t.mlir.prj/main_core_0_3.elf", link_with = "relu.o"}
    %_anonymous2 = aie.buffer(%tile_0_4) {address = 1536 : i32, mem_bank = 0 : i32, sym_name = "_anonymous2"} : memref<2xi32> 
    %core_0_4 = aie.core(%tile_0_4) {
      aie.end
    } {elf_file = "/home/steven/thesis/parrallel/SpecEE/SpecEE_cloud/build/relu_4c_1ch_1024_256t.mlir.prj/main_core_0_4.elf", link_with = "relu.o"}
    %_anonymous3 = aie.buffer(%tile_0_5) {address = 1536 : i32, mem_bank = 0 : i32, sym_name = "_anonymous3"} : memref<2xi32> 
    %core_0_5 = aie.core(%tile_0_5) {
      aie.end
    } {elf_file = "/home/steven/thesis/parrallel/SpecEE/SpecEE_cloud/build/relu_4c_1ch_1024_256t.mlir.prj/main_core_0_5.elf", link_with = "relu.o"}
